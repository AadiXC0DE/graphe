 ...
 *
 * Stricter than `readOnlyTools`, and for one reason: a helper that builds
 * changes nothing here and everything in a copy. A helper that only reads is
 * still allowed — looking around with company is still looking around.
 */
