...
export default function Skills({ open, skills, onClose, onRefresh, onOpen }: Props) {
  ...
  return (
    <section className="skills" aria-label="Skills library">
      <header className="skills__top">
        <div><p className="skills__eyebrow">Graphe skills</p><h1>Bring the right craft to the work.</h1><p>Type <code>@</code> in chat to choose one for a turn.</p></div>
