/** Work that waits to be let in, and the board's own machinery for the pieces
 * that run beside it.
 *
 * Every piece is a second working copy of the project sharing its history, so
 * nothing it does can touch the files on screen. Held work waits until somebody
 * takes it; a board piece is one of several going at once.
 */
